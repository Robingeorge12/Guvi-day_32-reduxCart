...
import "./Cart.css"
import {cartAdd,increment,decrement,cartUpate,cartDelete} from "../../Redux/cart"
...
function Cart() {
    ...
    // console.log(countCart,cartList) 
                     ...
                     <div className="col-sm-10 col-md-6 col-lg-5 cart-select">
                       <div className="selDiv">
                         <select
                           ...
                           onChange={(e) =>
                           dispatch(cartUpate({quantity:e.target.value, id:item.id}))
                           }
                           className="sel"
                         >
